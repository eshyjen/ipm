...
<div id="dataview"><br>
			...
			<a id="add" href="asset.html">
				...
				<div id="tablediv">
					 ...
					 <display:table id="usertable" name="<%=Constants.MANDATORY_CERTIFICATION_LIST %>" class="list" sort="page" pagesize="5" export="true" requestURI="mandatoryCertificationShow.html"  >
