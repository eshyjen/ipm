...
<html>
	...
	<body>
		...
		<div class='logintitle ericssonfont'>Certification</div>

		<div class='separator'></div>


		<div align='center'>
		<form:form  name="myForm" method="post" action="saveCertification.html" modelAttribute="certificationDTO">

		<font style="float:left; margin-left:20%">Employee Type:</font>
		  <font style="float:right;margin-right:25%"> <form:radiobutton path="employeeType" name="option" value="Yes"   />Internal
		<form:radiobutton path="employeeType" name="option" value="No"  />External  </font><br><br>
		...
		<font style="float:left; margin-left:20%">TNI Created in Gurukul?</font>
		  <font style="float:right;margin-right:32%"> <form:radiobutton path="tni" name="option" value="Yes"   />Yes
		<form:radiobutton path="tni" name="option" value="No"  />No  </font><br><br>


		  <font style="float:left; margin-left:20%">Completion Status:</font>
		  <font style="float:right;margin-right:32%"> <form:radiobutton path="completionStatus" name="option" value="Yes"   />Yes
