...
<body>
		...
		<div id="loginbox">
       	<div class='logintitle ericssonfont'> Certification List</div>
	...
	<form:form name="myform" id="myform">
		...
		<a id="add" href="certification.html">
			<img src="<%=request.getContextPath()%>/resources/images/add_button.gif" />
		</a>

			<div id="tablediv">

		  <display:table id="usertable" name="<%=Constants.CERTIFICATION_LIST %>"
				 class="list" sort="page" pagesize="5" export="true" requestURI="showCertification.html"  >
				  <display:column title="Edit/Delete"  paramProperty="id" paramId="id">
				   	 <a href="certificationForUpdate.html?id=${usertable.id}">
				   	 <img src="<%=request.getContextPath()%>/resources/images/edit_icon.gif" title="Edit" border="0">
				   			...
				   			<a href="removeCertification.html?id=${usertable.id}" onclick="return deleteMsg()">
				 ...
				 <display:column property="employeeType" title="Employee Type" sortable="true" sortProperty="employeeType"/>
				 ...
				 <display:column property="tni" title="TNI Created in Gurukul?" sortable="true" />
		  </display:table>
