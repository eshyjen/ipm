...
public class AssetController extends BaseController {
    ...
    public String saveAssetDetails(@ModelAttribute("assetDTO") @Valid final AssetDTO assetDTO,
            final BindingResult result, Model model, Principal prinicpal, HttpServletRequest request, HttpServletResponse response) {
